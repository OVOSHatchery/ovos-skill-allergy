...
class AllergyLevel(MycroftSkill):
    ...
    def handle_level_allergy_today_intent(self, message):
        ...
        self.speak_dialog("level.allergy.today", {"allergy_index_for_today": allergy_level_for_today,allergy_index_for_today})
        pass
    ...
    def handle_level_allergy_tomorrow_intent(self, message):
        ...
        self.speak_dialog("level.allergy.tomorrow", {"allergy_index_for_tomorrow": allergy_level_for_tomorrow, allergy_index_for_tomorrow})
